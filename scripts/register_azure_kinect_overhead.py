...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', type=str, default='cfg/register_azure_kinect_overhead.yaml', help='filename of a YAML configuration for registration')
    parser.add_argument('--intrinsics_dir', type=str, default='calib/azure_kinect_overhead/azure_kinect_overhead.intr')
